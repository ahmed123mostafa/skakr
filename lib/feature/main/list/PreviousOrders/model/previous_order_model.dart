class PreviousOrdersModel {
  ...
  factory PreviousOrdersModel.fromJson(Map<String, dynamic> json) {
    return PreviousOrdersModel(
      ...
      customerAddress: json['CustomerAddress'], // nullable
      onlineStoreId: json['OnlineStoreId'] ?? -1,
      ...
      taxesPercent: (json['TaxesPercent'] ?? 0).toDouble(),
      taxesValue: (json['TaxesValue'] ?? 0).toDouble(),
      payID: json['PayID'] ?? 0,
      payValue: (json['PayValue'] ?? 0).toDouble(),
      ...
      discountCardValue: (json['DiscountCardValue'] ?? 0).toDouble(),
      mapCustomerAddress: json['MapCustomerAddress'],
      mapPlaceID: json['MapPlaceID'],
      delivered: json['Delivered'] ?? false,
      prepare: json['Prepare'] ?? false,
      startDeliver: json['StartDeliver'] ?? false,
      sendingOrder: json['SendingOrder'] ?? false,
      underDeliver: json['UnderDeliver'] ?? false,
    );
  }
