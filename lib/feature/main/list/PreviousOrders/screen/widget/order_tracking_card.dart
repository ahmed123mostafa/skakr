...
//
//   OrderTrackingCard({super.key, required this.orderTrackingCubit});
//
//   @override
//   Widget build(BuildContext context) {
//     return ListView.builder(
//       itemCount: orderTrackingCubit.orderTrackingDetails?.length ?? 0,
...
//                             ),
//                             TextSpan(
//                               text: '${orderTrackingCubit.orderTrackingDetails?[index].orderNo ?? 0}',
//                               style: GoogleFonts.alexandria(
//                                 fontSize: 14.sp,
...
//                           children: [
//                             TextSpan(
//                               text: '${orderTrackingCubit.orderTrackingDetails?[index].finalValue ?? 0}',
//                               style: GoogleFonts.alexandria(
//                                 fontSize: 14.sp,
//                                 color: Colors.red,
//                                 fontWeight: FontWeight.w400,
...
//                     isActive: orderTrackingCubit.orderTrackingDetails?[index].sendingOrder ?? false,
...
//                     icon: Icons.check_circle,
//                     isActive: orderTrackingCubit.orderTrackingDetails?[index].startDeliver ?? false,
...
//                     icon: Icons.check_circle,
//                     isActive: orderTrackingCubit.orderTrackingDetails?[index].prepare ?? false,
//                     image: AppAssets.orderDeliveredIcon,
//                     divider: true,
//                   ),
//                   const SizedBox(height: 5),
...
//                     icon: Icons.check_circle,
//                     isActive: orderTrackingCubit.orderTrackingDetails?[index].underDeliver ?? false,
...
//                     icon: Icons.check_circle,
//                     isActive: orderTrackingCubit.orderTrackingDetails?[index].delivered ?? false,
//                     image: AppAssets.orderDeliveredIcon,
//                     divider: false,
//                   ),
//                 ],
